...
This section provides an exact reference for the flux jump module (\texttt{bionetflux.core.flux\_jump}) based on detailed analysis of the actual implementation. The module computes local flux balance contributions for HDG methods, serving as the Python equivalent of MATLAB \texttt{fluxJump.m}.
