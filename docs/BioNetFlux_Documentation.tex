...
The \code{Problem} class encapsulates the physics of a single arc:
...
The \code{Discretization} and \code{GlobalDiscretization} classes handle the spatial and temporal discretization parameters.
