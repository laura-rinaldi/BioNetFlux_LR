...
This section provides an exact reference for the global assembly module based on  the actual implementation in \texttt{bionetflux.core.lean\_global\_assembly.GlobalAssembler}. This class provides global assembly functionality using the lean BulkDataManager approach where framework objects are passed as parameters. Aim of the module is the assembly of the global functionals and operators from the individual domain components. 
