...
This section provides an exact reference for the Problem class (\texttt{ooc1d.core.problem.Problem}) based on detailed analysis of the actual implementation. The Problem class serves as the base container for single arc mathematical problem specification in BioNetFlux.
