...
This section provides a comprehensive reference for the domain geometry module (\texttt{domain\_geometry.py}), which provides lean geometry management for multi-arc BioNetFlux problems. The geometries that BioNetFlux considers are the union of rectilinear 1-dimensional rectilinear arcs (also called Domains within the code) embedded in a 2 dimensional plane. 
